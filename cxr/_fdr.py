...
parser.add_argument("--batch_num", default=100, type=int, required=True,
                        help="Number of batches")
parser.add_argument("--batch_size", default=100, type=int, required=True,
...
# python3 -u _fdr.py --data "cxr" --model "trained" --N 2000 --split_pr 0.5 --split_pr_tune 0.2
...
## load uncertainty/confidence scores
